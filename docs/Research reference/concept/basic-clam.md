...
<Image align="center" width="500px" src="https://files.readme.io/2fb634b-Artboard_182x.png" />
...
<Image align="center" width="500px" src="https://files.readme.io/f514986-Artboard_102x.png" />
...
<Image align="center" width="800px" src="https://files.readme.io/b9f5c74-Artboard_112x.png" />

For the Clam--

I - Input Layer - We will use 1 binary (0/1) neuron for *each* input (so Input=\[1,1,0] means Food and A but not C, etc.).
...
<Image align="center" width="500px" src="https://files.readme.io/5467c2e-Artboard_132x.png" />
...
<Image alt="For a better visual, please visit the miro board below." align="center" width="500px" src="https://files.readme.io/1dd1a64-Artboard_142x.png">
  For a better visual, please visit the miro board below.
</Image>

<HTMLBlock>{`
<iframe width="768" height="432" src="https://miro.com/app/live-embed/uXjVM_kESvI=/?moveToViewport=89203,-49112,16073,14223&embedId=897296881779" frameborder="0" scrolling="no" allow="fullscreen; clipboard-read; clipboard-write" allowfullscreen></iframe>
`}</HTMLBlock>
